...
const FinancialReports = () => {
  ...
  const renderTabContent = () => {
    ...
    switch (activeTab) {
      case 'overview':
        return <OverviewChart selectedPeriod={selectedPeriod} />;
      case 'categories':
        return <CategoryAnalysis selectedPeriod={selectedPeriod} />;
      case 'trends':
        return <TrendsAnalysis selectedPeriod={selectedPeriod} />;
      case 'budgets':
        return <BudgetTracking selectedPeriod={selectedPeriod} />;
      default:
        return <OverviewChart selectedPeriod={selectedPeriod} />;
    }
  };
